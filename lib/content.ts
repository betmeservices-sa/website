...
const es = {
    ...
    voice: {
      ...
      // Conversación en vivo (solo cuando el agente real está encendido).
      live: {
        sub: 'Habla con Aria desde tu navegador. Te escucha, te ve responder y contesta en el momento.',
        start: 'Toca para hablar',
        hint: 'La prueba dura hasta {s} segundos.',
        ...
        greet: 'Saluda cuando quieras.',
        caption: 'Aria responde con la información de MiAgentIA. Tu agente se entrena con la de tu negocio.',
        endTitle: '¿Lo quieres así para tu negocio?',
        micDenied: 'No pudimos usar tu micrófono. Actívalo en el navegador y vuelve a intentar.',
        micUnsupported: 'Este navegador no permite abrir el micrófono aquí. Prueba desde otro navegador.',
        limit: 'Llegaste al límite de pruebas por ahora. Escríbenos y seguimos sin reloj.',
        failed: 'La conversación no pudo abrirse. Inténtalo en un momento.',
      },
    },
...
const en: Dict = {
    ...
    voice: {
      ...
      live: {
        sub: 'Talk to Aria right from your browser. She hears you, you watch her answer, and she replies on the spot.',
        start: 'Tap to talk',
        hint: 'The trial runs up to {s} seconds.',
        ...
        hangUp: 'End',
        again: 'Talk again',
        greet: 'Say hi whenever you are ready.',
        caption: 'Aria answers with MiAgentIA information. Your agent is trained on yours.',
        endTitle: 'Want this for your business?',
        micDenied: 'We could not use your microphone. Allow it in your browser and try again.',
        micUnsupported: 'This browser cannot open the microphone here. Try a different one.',
        limit: 'You hit the trial limit for now. Message us and we keep talking, no clock.',
        failed: 'The conversation could not start. Please try again in a moment.',
      },
    },
